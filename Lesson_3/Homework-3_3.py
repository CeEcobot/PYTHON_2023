...
# создаем два словаря с ключами:
points_en = {1: 'AEIOULNSTR', 2: 'DG', 3: 'BCMP', 4: 'FHVWY', 5: 'K', 8: 'JZ', 10: 'QZ'}
points_ru = {1: 'АВЕИНОРСТ', 2: 'ДКЛМПУ', 3: 'БГЁЬЯ', 4: 'ЙЫ', 5: 'ЖЗЦХЧ', 8: 'ШЭЮ', 10: 'ФЩЪ'}
word = input('Введите сово: ').upper()
count = 0
    ...
    for sym in word:
        for key in points_ru:
            if sym in points_ru[key]:
                count += key
print(f'Вы получили {count} очков!')
